        ...
        while (runProgram) {
            switch (userInput) {
                ...
                case 1 -> { // Naujas pajamų įrašas
                    ...
                    String pajamosID = prefixPajamosID + idIn;
                    biudzetas.pajamuIrasas.add(new PajamuIrasas(parseDouble(irasas[0]), parseInt(irasas[1]), irasas[2], irasas[3], Boolean.parseBoolean(irasas[4]), pajamosID));
                    idIn++;
//                go to start of the program
                ...
                case 2 -> {// naujas išlaidų įrašas
                    ...
                    String islaidosID = prefixIslaidosID + idOut;
                    biudzetas.islaiduIrasas.add(new IslaiduIrasas(parseDouble(irasas[0]), irasas[1], parseInt(irasas[2]), irasas[3], irasas[4], islaidosID));
                    idOut++;
//                go to start of the program
                    userInput = 0;
                }
